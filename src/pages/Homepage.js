  ...
  return (
    <div className={styles.homepage}>
      ...
      <div className={styles.groupParent1}>
        ...
        <div className={styles.groupParent3}>
          <div className={styles.vectorGroup}>
            <img className={styles.vectorIcon6} alt="" src="/vector11.svg" />
      ...
      <div className={styles.groupParent4}>
        <div className={styles.groupParent5}>
          ...
          <div className={styles.vectorParent6}>
            <img className={styles.vectorIcon13} alt="" src="/vector11.svg" />
            <div className={styles.depressionDetectionTest}>
              Generalized Anxiety Disorder 7-item (GAD-7) scale
            </div>
          </div>
          <div className={styles.vectorParent7}>
            <img className={styles.vectorIcon14} alt="" src="/vector11.svg" />
            <div className={styles.depressionDetectionTest}>
      ...
      <div className={styles.groupParent6}>
        ...
        <div className={styles.groupParent7}>
          <div className={styles.vectorParent9}>
            <img className={styles.vectorIcon16} alt="" src="/vector11.svg" />
          ...
          <div className={styles.vectorParent11}>
            <img className={styles.vectorIcon18} alt="" src="/vector11.svg" />
      ...
      <div className={styles.toBeHeardIsToBeValidatedParent}>
        ...
        <img className={styles.vectorIcon21} alt="" src="/vector13.svg" />
      </div>
      <div className={styles.rectangleParent6}>
        ...
        <img className={styles.groupChild15} alt="" src="/group-451.svg" />
      </div>
    </div>
  );
};
