...
const AboutUs = () => {
  ...
  const onAboutUsTextClick = useCallback(() => {
    const anchor = document.querySelector("[data-scroll-to='ourVisionOur']");
    if (anchor) {
  ...
  return (
    <div className={styles.aboutUs}>
          ...
          <div className={styles.groupWrapper}>
            ...
            <div className={styles.ourServicesParent}>
              <div
                ...
                onClick={onOurServicesTextClick}
              >
                Our Services
              </div>
      ...
      <div className={styles.ourVisionOurVisionIsToCrParent}>
        <div
          className={styles.ourVisionOurContainer}
          data-scroll-to="ourVisionOur"
        >
