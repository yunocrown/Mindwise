      ...
      <div className={styles.groupParent}>
        <div className={styles.groupWrapper}>
          <div className={styles.groupContainer}>
            ...
            <div
              className={styles.homepageParent}
        ...
        <div className={styles.ourServicesGroup}>
          <div className={styles.ourServices2}>Our Services</div>
        ...
        <div className={styles.groupParent4}>
          <div className={styles.lineParent}>
            ...
            <img className={styles.groupChild11} alt="" src="/group-681.svg" />
          </div>
          ...
          <div className={styles.lineContainer}>
            ...
            <img className={styles.groupChild19} alt="" src="/group-681.svg" />
            <div className={styles.rectangleParent5}>
              <div className={styles.groupChild16} />
